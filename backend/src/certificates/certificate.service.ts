...
<style>
@font-face{font-family:'Stone Breaker';src:url('/fonts/Stone%20Breaker.woff2') format('woff2');font-weight:700 900;font-display:swap}
*{margin:0;padding:0;box-sizing:border-box}:root{--red:#ef3340;--red-dark:#d61f31;--ink:#111114;--paper:#fcfbf8}
body{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:18px;background:linear-gradient(135deg,#f7efe6 0%,#fcfbf8 55%,#f2ede6 100%);color:var(--ink);font-family:Inter,system-ui,-apple-system,'Segoe UI',Arial,sans-serif}
...
.main{position:relative;z-index:1;width:100%;height:100%;display:flex;flex-direction:column;align-items:center;text-align:center;padding:78px 40px 72px}.eyebrow{color:rgba(17,17,20,.56);letter-spacing:.32em;font-size:11px;text-transform:uppercase}.title{margin-top:6px;font-family:'Stone Breaker',Impact,'Arial Narrow',Arial,sans-serif;font-size:clamp(54px,7.2vw,80px);line-height:.92;color:var(--ink);text-transform:uppercase}.intro{margin-top:20px;font-size:13px;letter-spacing:.08em}.recipient{margin-top:10px;font-family:'Brush Script MT',cursive;font-size:clamp(50px,7.4vw,82px);color:var(--red)}.body-copy{max-width:760px;margin-top:12px;font-size:clamp(15px,1.65vw,19px);line-height:1.42;color:rgba(17,17,20,.9)}
.footer-signatures{display:flex;justify-content:center;gap:82px;margin-top:24px}.signature{min-width:150px}.signature-line{width:150px;height:34px;margin:0 auto 4px;border-bottom:1px solid rgba(239,51,64,.55)}.signature-name{font-weight:800}.signature-role{font-size:12px;line-height:1.35;margin-top:4px}.certificate-no{position:absolute;left:28px;bottom:32px;padding:8px 10px;border-radius:14px;border:1px dashed rgba(239,51,64,.45);background:rgba(255,255,255,.86);font-size:11px}.label{text-transform:uppercase;letter-spacing:.12em;color:rgba(17,17,20,.56);font-size:9px}.number{font-weight:800;margin-top:2px}
